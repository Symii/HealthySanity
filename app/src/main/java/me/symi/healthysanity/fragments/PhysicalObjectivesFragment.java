...
public class PhysicalObjectivesFragment extends Fragment
{
    ...
    public PhysicalObjectivesFragment(String date)
    {
        this.date = date;
    }
    ...
    {
        final View view = inflater.inflate(R.layout.fragment_physical_objectives, container, false);

        DatabaseHelper databaseHelper = new DatabaseHelper(view.getContext());
        final Cursor cursor = databaseHelper.getObjectives(ObjectiveType.PHYSICAL);
    ...
    private LinearLayout addObjectiveLayout(View view, String objectiveName)
    {
        ...
        imageView.setImageResource(R.drawable.ic_person_running_on_a_treadmill_silhouette_from_side_view);
